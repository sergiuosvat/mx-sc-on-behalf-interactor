    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn adjust_user_energy<
        Arg0: ProxyArg<MultiValueEncoded<Env::Api, MultiValue3<ManagedAddress<Env::Api>, BigInt<Env::Api>, BigInt<Env::Api>>>>,
    >(
        self,
        args: Arg0,
